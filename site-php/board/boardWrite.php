                ...
                <div class="boardType">
                    ...
                    <div class="board-write">
                        <form action="boardWriteSave.php" name="boardWrite" method="post">
                            <fieldset>
                                <legend class="ir_so">게시판 글쓰기 영역 입니다.</legend>
                                ...
                                <div>
                                    ...
                                    <textarea name="boardContent" id="boardContent" cols="30" rows="13" class="title-text" placeholder="내용을 작성해주세요!" required></textarea>
                                </div>
                            </fieldset>
