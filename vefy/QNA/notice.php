                            ...
                            <div class="board-search">
                                <form action="noticeSearch.php" name="noticeSearch" method="get">
                                    <fieldset class="search-field">
                                        ...
                                        <div class="p_box">
                                            <p class="choice"><a href="notice.php">공지사항</a></p>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            //board + member join
                                            $sql = "SELECT n.myNoticeID, n.noticeTitle, m.youName, n.noticeView, n.regTime FROM myMember m JOIN myNotice n ON (m.myMemberID = n.myMemberID) ORDER BY myNoticeID DESC LIMIT {$viewLimit}, {$numView}";                                            
                                            ...
                                            if($result){
                                                ...
                                                if($count > 0){
                                                    for($i=1; $i<=$count; $i++){
                                                        ...
                                                        echo "<td><a href='noticeView.php?noticeID={$info['myNoticeID']}'>".$info['noticeTitle']."</a></td>";
                            ...
                            <div class="board-page">
                                <ul>
                                    <?php
                                        ...
                                        $boardTotalCount = $boardTotalCount['count(myNoticeID)'];
