    ...
    <div class="cotainer">
        <div class="contentWrap">
            <div class="contentImg">
                <img src="../assets/img/체리.png" alt="스토어">
            </div>
            <div class="contentDesc">
                <div class="main_right">
                    <div class="right_top">
                        <div class="Goods_title">
                            <div class="title_main">체리</div>
        ...
        <div class="textBox">
            체리에는 딸기의 6배, 사과의 20에 달하는 철분이 풍부하게 함유되어 있다.<br> 
            <strong>빈혈 예방 염증 퇴치 
            수면 호르몬 상승 
            다이어트 
            피부 미용 
            피로 해소 
            당뇨 예방 
            노화 억제</strong>에 효과적이다.
        </div>
        <div class="imgBox">
            <img src="../assets/img/kang.png" alt="강동재">
        </div> 
        </div>
    </div>
